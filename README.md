...
Lighthouse53 is a simple dynamic DNS utility. It upserts domain records in Amazon Web Services' Route53 with your network's public IP address.
...
##Usage
```
usage: lighthouse53 [-h] [--loglevel {CRITICAL,ERROR,WARN,INFO,DEBUG}]
                    [--ttl TTL]
                    name hostedZoneId
...
###Example:
```
/opt/lighthouse53/lighthouse53 --ttl 1200 your.domain.com Z272WSEOS672FM
```
